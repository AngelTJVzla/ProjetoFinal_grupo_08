                        ...
                        <div key={empresa.id || idx} className="bg-gray-800/90 rounded-xl p-6 border border-blue-400/40 hover:bg-gray-700/90 transition-all duration-200 shadow-lg hover:shadow-xl">
                            <div className="flex items-start justify-between mb-4">
                                <div className="flex items-center">
                                    ...
                                    <div>
                                        <h3 className="text-lg font-bold text-white">{empresa.nombre}</h3>
                                        <p className="text-blue-300 text-sm">ID: {empresa.id}</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="space-y-3 mb-6">
                                <div className="flex items-center space-x-3">
                                    ...
                                    <div>
                                        <p className="text-blue-200/70 text-xs font-medium uppercase tracking-wide">CNPJ</p>
                                        <p className="text-purple-300 font-mono text-sm">{formatCNPJ(empresa.cnpj) || "Não informado"}</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-center space-x-3">
                                    ...
                                    <div>
                                        <p className="text-blue-200/70 text-xs font-medium uppercase tracking-wide">Setor</p>
                                        <p className="text-green-300 text-sm font-medium">{empresa.sector}</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-center space-x-3">
                                    ...
                                    <div>
                                        <p className="text-blue-200/70 text-xs font-medium uppercase tracking-wide">Contato</p>
                                        <p className="text-blue-300 text-sm font-medium break-all">{empresa.contacto}</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-center space-x-3">
                                    ...
                                    <div>
                                        <p className="text-blue-200/70 text-xs font-medium uppercase tracking-wide">Tipo de Ajuda</p>
                                        <p className="text-yellow-300 text-sm font-medium">{empresa.ayuda}</p>
                                    </div>
                                </div>
                            </div>
                ...
                >
                    <div className="bg-gray-50 rounded-lg p-6">
                        <form className="space-y-4">
                            ...
                            <div>
                                <label className="block text-gray-700 text-sm font-semibold mb-2">Setor</label>
                                <input 
                                    className="w-full p-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent" 
                                    name="setor" 
                                    value={form.setor} 
                            ...
                            <div>
                                <label className="block text-gray-700 text-sm font-semibold mb-2">Tipo de Ajuda</label>
                                <input 
                                    className="w-full p-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent" 
                                    name="ajuda" 
                                    value={form.ajuda} 
                                    onChange={handleChange} 
                                    placeholder="Tipo de ajuda oferecida" 
                                />
                            </div>
                            {error && (
                                <div className="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded-lg">
